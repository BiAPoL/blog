...
In this blog post we show how to browse the IDR programmatically in Python.
...
This also works from [Google Colab](https://colab.research.google.com/github/biapol/blog/notebooks/browse_idr.ipynb).
