...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(240, 115)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setMinimumSize(QtCore.QSize(240, 76))
        ...
        self.gridLayout.addWidget(self.horizontalSlider, 1, 2, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Apply Δ°C"))
        self.label_2.setText(_translate("MainWindow", "Water Level"))
        self.label.setText(_translate("MainWindow", "Temperature Increase"))
