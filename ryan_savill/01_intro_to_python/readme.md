...
[Ryan Savill](https://biapol.github.io/blog/ryan_savill), June 17th 2021
...
What zip actually does is create a list of tuples of the two input arrays. We can then access both of these elements at once when using a for-loop. If one list is shorter it will only loop through the indices of the shorter list as we can see that the last element in processing times is not printed.
...
If you want to try out the code in this post just look through the [github repository](https://github.com/biapol/blog/ryan_savill), where all code is available for you to download and try!
